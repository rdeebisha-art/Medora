...
import { malayalamDictionary, kannadaDictionary, englishDictionary, hindiDictionary } from './otherLanguages';

export * from './tamilHealthcare';
export * from './teluguHealthcare';
export * from './otherLanguages';

export type SupportedLanguageCode = 'ta-IN' | 'te-IN' | 'ml-IN' | 'kn-IN' | 'en-IN' | 'hi-IN';
...
export const LANGUAGE_METADATA: Record<SupportedLanguageCode, { code: SupportedLanguageCode; name: string; nativeName: string; flag: string }> = {
  ...
  'hi-IN': { code: 'hi-IN', name: 'Hindi', nativeName: 'हिन्दी', flag: '🇮🇳' },
