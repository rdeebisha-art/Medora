...
const DICTIONARY: Record<LanguageCode, Record<string, string>> = {
  ...
  hi: {
    ...
    // A2A Simulation
    'Rural Patient — Report + Symptoms Assessment': 'ग्रामीण मरीज — रिपोर्ट + लक्षण मूल्यांकन',
    'Assisted Access A2A Workflow': 'सहायक पहुंच A2A कार्यप्रवाह',
    'Basic / Button Phone User': 'बेसिक / बटन फोन उपयोगकर्ता',
    'Assisted Medora Access': 'सहायक मेडोरा पहुंच',
    'Scan Medical Report': 'मेडिकल रिपोर्ट स्कैन करें',
    'Extracted Information': 'निकाली गई जानकारी',
    'Extracted from demo report': 'डेमो रिपोर्ट से निकाला गया',
    'What symptoms is the patient experiencing?': 'मरीज को क्या लक्षण अनुभव हो रहे हैं?',
    'A2A Simulation Ready': 'A2A सिमुलेशन तैयार',
    'Start Simulation': 'सिमुलेशन शुरू करें',
    'Sequential Execution Stages (1–12)': 'अनुक्रमिक निष्पादन चरण (1-12)',
    'Specialists Consulted (Agent-to-Agent Cards)': 'परामर्शित विशेषज्ञ (एजेंट-टू-एजेंट कार्ड)',
    'Selection Reason:': 'चयन का कारण:',
    'FINAL RESPONSE': 'अंतिम प्रतिक्रिया',
    'Doctor Handoff Packet': 'डॉक्टर हैंडऑफ पैकेट',
    'Generate Doctor Summary': 'डॉक्टर सारांश बनाएं',
    'Future Integration / Prototype Concept': 'भविष्य का एकीकरण / प्रोटोटाइप अवधारणा',
    'Reset Simulation': 'सिमुलेशन रीसेट करें',

    // Communication Center & Data Sharing
    ...
    'Review selected recipients and permissions': 'चयनित प्राप्तकर्ताओं और अनुमतियों की समीक्षा करें',
    'Share Health Data & Reports': 'स्वास्थ्य डेटा और रिपोर्ट साझा करें',
    '+ Share Health Data': '+ स्वास्थ्य डेटा साझा करें',
    'Outbox & Sent': 'आउटबॉक्स और भेजे गए',
    'Inbox': 'इनबॉक्स',
    'OFFLINE QUEUED': 'ऑफलाइन कतारबद्ध',
    'DELIVERED': 'वितरित',
    'FAILED': 'विफल',
    'Sync Pending Now': 'लंबित संदेशों को अभी सिंक करें',
    'Retry Lakshmi': 'लक्ष्मी को पुनः प्रयास करें',
    'Kumar Family Profile': 'कुमार परिवार प्रोफाइल',
    'Family Health Overview': 'पारिवारिक स्वास्थ्य अवलोकन',
    ...
    'Welcome to MEDORA ❤️': 'मेडोरा में आपका स्वागत है ❤️',
    'Your Rural Health Companion': 'आपका ग्रामीण स्वास्थ्य साथी',
    '🌐 Choose Your Language': '🌐 अपनी भाषा चुनें',
    'Explore Medora Platform': 'मेडोरा प्लेटफॉर्म देखें',
    '❓ WHAT SHOULD I DO?': '❓ मुझे क्या करना चाहिए?',
    'Primary Actions': 'प्राथमिक कार्य',
    'Your Health Records': 'आपके स्वास्थ्य रिकॉर्ड',
    'Household Members': 'पारिवारिक सदस्य',
    'Medical Tests': 'मेडिकल परीक्षण',
    'Daily Medicines': 'दैनिक दवाएं',
    'Doctor Visits': 'डॉक्टर की सलाह',
    '❓ MEDORA HELP & FAQ': '❓ मेडोरा सहायता और अक्सर पूछे जाने वाले प्रश्न',
    'USSD Simulator (*123#)': 'USSD सिम्युलेटर (*123#)',
    'Voice / IVR Phone Call': 'वॉयस / आईवीआर फोन कॉल',
  },
  te: {
    // Navigation & Global Header
    ...
    // A2A Simulation
    'Rural Patient — Report + Symptoms Assessment': 'గ్రామీణ రోగి — నివేదిక + లక్షణాల అంచనా',
    'Assisted Access A2A Workflow': 'సహాయక ప్రాప్యత A2A వర్క్‌ఫ్లో',
    'Basic / Button Phone User': 'బేసిక్ / బటన్ ఫోన్ వినియోగదారు',
    'Assisted Medora Access': 'సహాయక మెడోరా ప్రాప్యత',
    'Scan Medical Report': 'మెడికల్ నివేదికను స్కాన్ చేయండి',
    'Extracted Information': 'సేకరించిన సమాచారం',
    'Extracted from demo report': 'డెమో నివేదిక నుండి సేకరించబడింది',
    'What symptoms is the patient experiencing?': 'రోగి ఎలాంటి లక్షణాలను అనుభవిస్తున్నారు?',
    'A2A Simulation Ready': 'A2A సిమ్యులేషన్ సిద్ధంగా ఉంది',
    'Start Simulation': 'సిమ్యులేషన్ ప్రారంభించండి',
    'Sequential Execution Stages (1–12)': 'క్రమానుగత దశలు (1–12)',
    'Specialists Consulted (Agent-to-Agent Cards)': 'సంప్రదించిన నిపుణులు (ఏజెంట్-టు-ఏజెంట్ కార్డ్‌లు)',
    'Selection Reason:': 'ఎంపిక కారణం:',
    'FINAL RESPONSE': 'చివరి స్పందన',
    'Doctor Handoff Packet': 'డాక్టర్ హ్యాండ్‌ఆఫ్ ప్యాకెట్',
    'Generate Doctor Summary': 'డాక్టర్ సారాంశాన్ని రూపొందించండి',
    'Future Integration / Prototype Concept': 'భవిष्य విలీనం / ప్రోటోటైప్ భావన',
    'Reset Simulation': 'సిమ్యులేషన్ రీసెట్ చేయండి',
  },
  ml: {
    // Navigation & Global Header
    'MEDORA': 'മെഡോറ (Medora)',
